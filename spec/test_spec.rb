...
describe 'Word_Count' do
  ...
  describe "Word_Count.sort_hash" do
    it "sorts the hash into an descening ordered array by occurance value" do
      expect(word_count.sort_hash(test_hash)).to eq test_array_sorted
    end
  end

  describe "Word_Count.top_ten" do
    it "returns the top ten most frequent words" do
      expect(word_count.top_ten(test_array_sorted)).to eq([["of", 8], ["the", 6], ["this", 4], ["that", 4], ["in", 4], ["and", 4], ["is", 3], ["books", 2], ["finding", 2], ["a", 2]])
    end
  end
end
