...
― Jorge Luis Borges, The Library Of Babel"
  ...
  final_top_ten_test_books = "processing babel.txt...\nprocessing galaxy1.txt...\nprocessing galaxy2.txt...\nprocessing super_science_1.txt...\nprocessing super_science_2.txt...\nTHE TOP TEN WORDS\n=================\n1. the, count: 12235\n2. of, count: 5530\n3. a, count: 4705\n4. and, count: 4691\n5. to, count: 4500\n6. in, count: 2990\n7. i, count: 2720\n8. he, count: 2598\n9. was, count: 2473\n10. it, count: 2263\n"
...
describe "Parser" do
  ...
  describe "Main" do
    describe "#process files" do
      it "reads in all the files at the specified directory and prints the final top ten word_count to the console" do
        expect{Main.process_files("./test_books/")}.to output(final_top_ten_test_books).to_stdout
      end
    end
  end